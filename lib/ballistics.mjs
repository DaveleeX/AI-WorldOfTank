...
export const ROAD_WHEELS={china:6,france:6,japan:5,challenger:6,leopard:7,abrams:7};
for(const g of Object.values(GUNS)){g.height*=.86;g.fore*=1.12;g.length*=1.2;}
export function gunSpec(model,barrel=0){return {...GUNS[model],length:barrel===1?5.28:barrel===2?3.3:GUNS[model].length};}
